...
def get_parameter():
    ...
    parser.description = 'This program can calculate the ranking of network nodes in the form of gene expression data or adjacency matrix through a weighted LeaderRank algorithm'
    ...
    help="Whether it is necessary to output the network cut according to threshold. If the input is not zero, set the threshold to change and outpu. Default:0")
...
if __name__ == "__main__":
    ...
    run_file = os.path.join(run_file,"bin","Debug","LRCu.exe")
